...
public class CardScaleHelper {
    ...
    private int mCurrentItemPos;//当前需要居中的卡片
    private int mCurrentItemOffset;//RecyclView滑动距离
    ...
    public void attachToRecyclerView(final RecyclerView mRecyclerView) {
        ...
        mRecyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                ...
                FRLog.v(String.format("dx=%s, dy=%s, mScrolledX=%s", dx, dy, mCurrentItemOffset));
    ...
    private void initWidth() {
        mRecyclerView.post(new Runnable() {
            ...
            public void run() {
                ...
                mCardWidth = mCardGalleryWidth - DeviceUtils.dip2px(mContext, 2 * (mPagePadding + mShowLeftCardWidth));
    ...
    private void computeCurrentItemPos() {
        ...
        if (pageChanged) {
            ...
            FRLog.d(String.format("=======onCurrentItemPos Changed======= tempPos=%s, mCurrentItemPos=%s", tempPos, mCurrentItemPos));
        }
    }
    ...
    private void onScrolledChangedCallback() {
        ...
        FRLog.d(String.format("offset=%s, percent=%s", offset, percent));
        View leftView = null;
        View currentView;
        View rightView = null;
